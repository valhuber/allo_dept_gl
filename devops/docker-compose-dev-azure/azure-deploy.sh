...
resourcename="allodeptgl"  # lower case, only
resourcegroup="allodeptgl_rg"
...
# git clone https://github.com/apilogicserver/allodeptgl.git
# cd allodeptgl
...
az group create --name allodeptgl_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group allodeptgl_rg --sku S1 --is-linux
az container create --resource-group allodeptgl_rg --name allodeptgl --image apilogicserver/allodeptgl:latest --dns-name-label allodeptgl --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//allodeptgl.westus.azurecontainer.io:5656'
